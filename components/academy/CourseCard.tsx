...
export default function CourseCard({
  ...
  return (
    <Link
      ...
      className={`flex items-center justify-center w-[175px] h-[350px] md:h-[486px] relative flex-shrink-0 flex-col p-4 bg-gray-300 courses-overlay md:hover:w-[384px] md:hover:h-[486px] group transition-in duration-500${
