    ...
    <div className="flex h-screen snap-center flex-col bg-[#3D5656] p-8 py-32 font-barlow">
      <div className="flex flex-col justify-between space-y-5 md:flex-row md:p-20">
        ...
        <div className="col-span-1 flex flex-col space-y-1">
          ...
          <div className="flex w-[210px] flex-col gap-2 divide-y-2 divide-green-300">
            <div>
            ...
            <div className="flex h-[22px] w-[210px] flex-row items-center justify-between pt-4 text-white">
              <Link
      ...
      <div className="self-stretch border-t border-green-300 pt-4 text-center text-green-300 text-white">
        © Copyright {GetYear()} by{" "}
        <Link href={"/"} className="text-green-300 text-primary">
          LandaHolding
        </Link>
      </div>
    </div>
