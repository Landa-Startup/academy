...
const CourseItem = ({ title, image }: { title: string; image: string }) => {
  return (
    <Link
      ...
      className="courses-overlay group relative m-8 flex h-[350px] w-[175px] shrink-0 flex-col items-center justify-center  bg-gray-300 p-4 duration-500 md:h-[400px] md:hover:h-[400px] md:hover:w-[384px]"
    >
