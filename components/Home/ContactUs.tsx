      ...
      <div className="relative grid grid-cols-1 gap-[-2rem] z-10 md:grid-cols-2 ">
        <div className="col-span-1 w-full md:w-1/2 lg:ml-[21rem]">
          <Input
            ...
            className="inline-flex h-[40px] w-full items-center justify-start border rounded-md border-yellow-400 bg-yellow-50 pl-5 md:h-[50px]"
        ...
        <Input
          ...
          className="inline-flex h-[40px] w-[360px] items-center justify-start rounded-md border border-yellow-400 bg-yellow-50 pl-5 md:h-[50px] lg:ml-[0rem] "
        ...
        <PhoneInputWithCountrySelect
          ...
          className="!important] inline-flex h-[40px] w-[360px] items-center justify-start rounded-md border border-yellow-400 bg-yellow-50 pl-5 md:h-[50px]  lg:ml-[21rem] [&>*:nth-child(1)]:border-r-2 [&>*:nth-child(2)]:bg-yellow-50 "
        />
        <Input
          register={register}
          errors={errors}
          ...
          className="mt-5 inline-flex h-[40px] w-[360px] items-center rounded-md justify-start border border-yellow-400 bg-yellow-50 pl-5 md:h-[50px] lg:ml-[0rem] lg:mt-0 "
          labelClass="text-[#6b6b6b] dark:text-current"
        />
        <TextArea
          register={register}
          ...
          className=" h-[84px] w-[360px] justify-start border rounded-md border-yellow-400 bg-yellow-50 pl-5 md:h-[185px] md:w-[746px] lg:mb-[-38px] lg:ml-[335px] lg:mr-[323px] lg:mt-[-0.5rem] mb-4"
        />
      </div>
      <div className="mt-8">
        <Button
